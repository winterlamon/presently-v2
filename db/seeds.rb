...
#     all_listings = RestClient.get("https://openapi.etsy.com/v2/listings/active?includes=Images(url_170x135)&fields=title,price,description,url,category_id&limit=5000&api_key=z6u2v4p18o5m8va3gpv5132a", {params:{offset: counter}})
